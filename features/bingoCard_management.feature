...
Funcionalidade: Gerenciamento de Cartelas de Bingo
  ...
  Cenário: Criação de uma Nova Cartela de Bingo com Números Válidos
  ...
  Cenário: Tentativa de Criação de Cartela com Campo Vazio
    Dado que estou logado como "Getulio" com a senha "032023" e na página homeUser com o evento "Bingao do IF" existente
    Quando clico em "Nova Cartela" para o evento "Bingao do IF"
  ...
  Cenário: Tentativa de Criação de Cartela com Campo Não Numérico
    Dado que estou logado como "Getulio" com a senha "032023" e na página homeUser com o evento "Bingao do IF" existente
    Quando clico em "Nova Cartela" para o evento "Bingao do IF"
  ...
  Cenário: Tentativa de Criação de Cartela com Número Fora do Intervalo
    Dado que estou logado como "Getulio" com a senha "032023" e na página homeUser com o evento "Bingao do IF" existente
    Quando clico em "Nova Cartela" para o evento "Bingao do IF"
  ...
  Cenário: Tentativa de Criação de Cartela com Números Repetidos
    Dado que estou logado como "Getulio" com a senha "032023" e na página homeUser com o evento "Bingao do IF" existente
    Quando clico em "Nova Cartela" para o evento "Bingao do IF"
  ...
  Cenário: Visualização de Cartelas de Bingo de um Evento
  ...
  Cenário: Visualização de Cartelas de Bingo de um Evento Sem Cartelas
  ...
  Cenário: Edição de uma Cartela de Bingo Existente
  ...
  Cenário: Exclusão de uma Cartela de Bingo
    Dado que estou logado como "Getulio" com a senha "032023" e na página homeBingoCard com a cartela de ID "1" do evento "Bingao do IF" existente
