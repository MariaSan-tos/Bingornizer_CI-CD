...
Funcionalidade: Gerenciamento de Perfil de Usuário #H5
  Como um usuário logado
  Eu quero editar e deletar meu perfil
  Para manter minhas informações atualizadas ou remover minha conta

  Cenário: Edição de Perfil de Usuário - Alterar Username e Email #H5C1
  ...
  Cenário: Edição de Perfil de Usuário - Alterar Senha #H5C1
  ...
  Cenário: Exclusão de Perfil de Usuário #H5C2
