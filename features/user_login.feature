...
Funcionalidade: Login no Sistema #H2
  Como um usuário registrado
  Eu quero fazer login no sistema
  Para acessar meus eventos e cartelas de bingo

  Cenário: Login Bem-Sucedido #H2C1
  ...
  Cenário: Login com Credenciais Inválidas - Senha Incorreta #H2C2
    Dado que estou na página de login
  ...
  Cenário: Login com Credenciais Inválidas - Email Inexistente #H2C2
    Dado que estou na página de login
    Quando insiro o email "naoexiste@teste.com" inexistente e a senha "senha123" válida
    Então o sistema deve exibir a mensagem "usuario inexistente"
    E minha sessão de usuário não deve ser estabelecida

  Cenário: Login com Credenciais Inválidas - Ambos Inválidos #H2C2
    Dado que estou na página de login
