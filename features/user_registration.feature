...
Funcionalidade: Cadastro de Usuário
  ...
  Cenário: Tentativa de Registro com Campos Vazios - Username Vazio
    Dado que estou na página de cadastro
  ...
  Cenário: Tentativa de Registro com Campos Vazios - Email Vazio
    Dado que estou na página de cadastro
  ...
  Cenário: Tentativa de Registro com Campos Vazios - Senha Vazia
    Dado que estou na página de cadastro
  ...
  Cenário: Tentativa de Registro com Campos Inválidos - Username muito curto
    Dado que estou na página de cadastro
  ...
  Cenário: Tentativa de Registro com Campos Inválidos - Email sem @
    Dado que estou na página de cadastro
  ...
  Cenário: Tentativa de Registro com Campos Inválidos - Senha muito curta
    Dado que estou na página de cadastro
